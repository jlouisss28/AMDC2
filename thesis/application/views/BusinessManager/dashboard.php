        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php
                    $conn =mysqli_connect("localhost","root","", "itproject") or die('Error connecting to MySQL server.');
                  $sql = "SELECT COUNT(*) AS total FROM returns WHERE return_status = 'Pending'";
                  $result = $conn->query($sql);    
              ?>
                <?php if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) { ?>
                   ...
                   ?>
                    ...
                    <form action="<?php echo 'BusinessManager/returns'?>" method="get">
                      ...
                      <td>
                          ...
                          <button type="button" id="getReturn" class="btn btn-success" data-toggle="modal" data-target="#returnModal" data-id="<?php echo $row["return_id"]; ?>"><i class="fa fa-share"></i><i class="far fa-hospital"></i></i> Return </button>
