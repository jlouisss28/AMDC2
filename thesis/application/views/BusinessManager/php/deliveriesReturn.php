...
<form class="form-horizontal" method="post" action="deliveries/returnItems">
                            ...
                            ?>
                                                                           ...
                                                                           <?php
                        $sql="SELECT * FROM purchase_orders join purchase_order_bm USING(purchase_order_uniq_id) join supplies on description = supply_description join suppliers on supplier = company_name where purchase_order_uniq_id='$per_po_uniq_id' AND purchase_order_id='$id' AND order_quantity != 0 GROUP BY lot_no";
