            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <?php 
                                $sql="SELECT * FROM inventory_order JOIN inventory_order_supplies USING(inventory_order_uniq_id) JOIN supplies ON supplies.supply_description=inventory_order_supplies.supply_name WHERE inventory_order_id=$id AND quantity !=0 AND quantity_remaining !=0 GROUP BY lot_no";
                        ...
                        <div class="row">
                            ...
                            <table class="table table-bordered" id="item_table">
                                ...
                                <?php }else{ ?>
                                    <th width="12%">Remaining Balance</th>
                                <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($qty_stock[$zero] > 0){ 
                                            ...
                                            <input type="number" class="form-control" id="qtyIssued<?php echo $x; ?>" name="qtyIssued<?php echo $x; ?>" value="" style="border: 0; outline: 0;  background: transparent; border-bottom: 1px solid black;" min="1" max="<?php print_r($qty_ordered[$zero]);?>" required>
                                            <?php }else { ?>
                                                <input type="number" class="form-control" id="qtyIssued<?php echo $x; ?>" name="qtyIssued<?php echo $x; ?>" value="" style="border: 0; outline: 0;  background: transparent; border-bottom: 1px solid black;" min="1" max="<?php print_r($qty_stock[$zero]);?>" required>
                                            <?php } ?>
                                        <?php } else { ?>
                                            <center>
