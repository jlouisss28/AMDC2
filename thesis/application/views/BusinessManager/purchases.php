                                                        ...
                                                        <?php 
                                                          ...
                                                          if ($resulty->num_rows > 0) {
                                                            while($row = $resulty->fetch_assoc()) {
                                                              ...
                                                              $counter1 = $order2+1; 
                                                        ?>
                                                        <input type="text" class="form-control" id="orderNum" name="orderNum" value="<?php echo 'PO'.$date.'-'.$counter1; ?>" style="border: 0; outline: 0;  background: transparent; border-bottom: 1px solid black; background-color: #f1f1f1;" >
                                                      <?php }else{ ?>
